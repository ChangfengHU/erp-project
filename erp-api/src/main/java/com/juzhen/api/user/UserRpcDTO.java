...
public class UserRpcDTO implements org.apache.thrift.TBase<UserRpcDTO, UserRpcDTO._Fields>, java.io.Serializable, Cloneable, Comparable<UserRpcDTO> {
  ...
  public UserRpcDTO setUsername(String username) {
    this.username = username;
    return this;
  }
  ...
  public UserRpcDTO setPassword(String password) {
    this.password = password;
    return this;
  }
  ...
  public UserRpcDTO setSalt(String salt) {
    this.salt = salt;
    return this;
  }
  ...
  public UserRpcDTO setEmail(String email) {
    this.email = email;
    return this;
  }
  ...
  public UserRpcDTO setRealName(String realName) {
    this.realName = realName;
    return this;
  }
  ...
  public UserRpcDTO setMobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public UserRpcDTO setCreateTime(String createTime) {
    this.createTime = createTime;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserRpcDTO(");
    boolean first = true;
