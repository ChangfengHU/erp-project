...
import com.juzhen.edge.user.redis.RedisClient;
import com.juzhen.edge.user.response.LoginResponse;
import com.juzhen.edge.user.response.Response;
import com.juzhen.edge.user.thrift.ServiceProvider;
import com.juzhen.edge.user.vo.UserInfoVO;
