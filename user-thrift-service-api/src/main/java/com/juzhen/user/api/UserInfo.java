...
public class UserInfo implements org.apache.thrift.TBase<UserInfo, UserInfo._Fields>, java.io.Serializable, Cloneable, Comparable<UserInfo> {
   ...
   * 类型 1 管理员  2 工厂 3销售
   */
  public UserInfo setKind(int kind) {
    this.kind = kind;
    setKindIsSet(true);
    return this;
  }
  ...
  public UserInfo setCreateUserId(int createUserId) {
    this.createUserId = createUserId;
    setCreateUserIdIsSet(true);
    return this;
  }
  ...
  public UserInfo setCreateTime(java.lang.String createTime) {
    this.createTime = createTime;
    return this;
  }
